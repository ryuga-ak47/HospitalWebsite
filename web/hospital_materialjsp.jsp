<%-- 
    Document   : hospital_material
    Created on : 13 Jul, 2018, 10:48:05 PM
    Author     : akshay
--%>
      ...
      <tr>
       ...
       try{
          Connection c = DriverManager.getConnection("jdbc:derby://localhost:1527/Hospital_managementDB","abc","abc");
           String q = "select * from ABC.EQUIPMENTS";
          ...
          ResultSet rs =  ps.executeQuery();
           ...
           while(rs.next()){
              ...
              <td><%out.println(rs.getString("EQUIPMENT"));%></td>
                <td><%out.println(rs.getString("QUANTITY"));%></td>
                <td><%out.println(rs.getString("EQUIPPED"));%></td>
                <td><%out.println(rs.getString("EQUIPPED_DOCTOR"));%></td>
