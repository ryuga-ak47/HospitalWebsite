<%-- 
    Document   : patientsjsp
    Created on : 8 Jul, 2018, 1:25:25 PM
    Author     : akshay
--%>
      ...
      <tr>
       ...
       try{
          Connection c1 = DriverManager.getConnection("jdbc:derby://localhost:1527/Hospital_managementDB","abc","abc");
           String q = "select * from ABC.APPOINTMENTDB";
          ...
          ResultSet rs =  ps.executeQuery();
           ...
           while(rs.next()){
             ...
             <td><%out.println(rs.getString("FULL_NAME"));%></td>
                ...
                <td><%out.println(rs.getString("EMAIL_ADDRESS"));%></td>
                <td><%out.println(rs.getString("BLOOD_GROUP"));%></td>
               <td><%out.println(rs.getString("GUARDIAN_NAME"));%></td>
               <td><%out.println(rs.getString("ADMITTED"));%></td>
